...
| 順位 | 失敗パターン | 件数 | 登録者 |
| --- | --- | --- | --- |
| 1 | 顧客側データオーナーとの合意形成が長期化した | **7 件** | 6 名 |
| 2 | 基幹システムのIF仕様が古く、結合テストで手戻りが出た | **6 件** | 6 名 |
| 3 | 権限・アクセス制御の設計を後回しにした | **5 件** | 5 名 |
...
#### 追い込み質問（個人の失敗なのか組織の課題なのか）

```
最も多い失敗パターンについて、それは何件の案件で、何人が登録したものですか。
同じ人が繰り返し登録しているのか、別々の人が独立に登録しているのかも教えて。
```

<u>**確認ポイント**</u>  

- 件数と人数が一致しているか
  件数と人数は一致せず、件数の方が 1 多いです。
- 2 件登録している人がいるか
  `橋本 陽介` だけ 2 件登録で、残りは全員 1 件だけ登録となっています。

最も多い失敗パターンについて、**ほぼ全員が別々に同じ失敗を踏んでいる** ことがわかります。  
1 人が繰り返し失敗しているのであれば個人の問題ですが、そうでない場合は「組織の課題」と識別できます。失敗の構造をオントロジーを使って確認することができます。  
