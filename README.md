...
Microsoft Fabric のオントロジーワークショップリポジトリへようこそ！  
このリポジトリは、Microsoft Fabric のオントロジーについて学ぶのに役立つよう設計されています。実践的な例やリソースを提供しています。Microsoft Fabric で初めてオントロジーを使う方も、理解を深めたい方も、ここで貴重な洞察やツールを見つけることができます。
